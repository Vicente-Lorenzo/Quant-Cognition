...
from Library.Indicator.Configuration import IndicatorType, IndicatorConfigurationAPI
...
class IndicatorsAPI:
    ...
    SMA = IndicatorConfigurationAPI(
        ...
        Input=lambda market: [market.Close.Bid],
        Parameter={"window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda window: window >= 5,
        Function=lambda series, window: talib.SMA(*series, timeperiod=window),
        Output=["Result"],
        FilterBuy=lambda market, indicator, shift: market.Close.Bid.over(indicator.Result, shift),
        FilterSell=lambda market, indicator, shift: market.Close.Bid.under(indicator.Result, shift),
        SignalBuy=lambda market, indicator, shift: market.Close.Bid.crossover(indicator.Result, shift),
        SignalSell=lambda market, indicator, shift: market.Close.Bid.crossunder(indicator.Result, shift))
    ...
    @staticmethod
    def _custom_hma_(series, window):
    ...
    HMA = IndicatorConfigurationAPI(
        ...
        Parameter={"window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda window: window >= 5,
        Function=lambda series, window: IndicatorsAPI._custom_hma_(series, window),
        Output=["Result"],
        FilterBuy=lambda market, indicator, shift: market.Close.Bid.over(indicator.Result, shift),
        FilterSell=lambda market, indicator, shift: market.Close.Bid.under(indicator.Result, shift),
        SignalBuy=lambda market, indicator, shift: market.Close.Bid.crossover(indicator.Result, shift),
    ...
    SMAC = IndicatorConfigurationAPI(
        ...
        Input=lambda market: [market.Close.Bid],
        Parameter={"fast_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]], "slow_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
    ...
    HMAC = IndicatorConfigurationAPI(
        ...
        Parameter={"fast_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]], "slow_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda fast_window, slow_window: 5 <= fast_window < slow_window,
        Function=lambda series, fast_window, slow_window: (IndicatorsAPI._custom_hma_(series, fast_window), IndicatorsAPI._custom_hma_(series, slow_window)),
        Output=["Fast", "Slow"],
        FilterBuy=lambda _, indicator, shift: indicator.Fast.over(indicator.Slow),
        FilterSell=lambda _, indicator, shift: indicator.Fast.under(indicator.Slow),
        SignalBuy=lambda _, indicator, shift: indicator.Fast.crossover(indicator.Slow),
    ...
    AROON = IndicatorConfigurationAPI(
        ...
        Input=lambda market: [market.High.Bid, market.Low.Bid],
        Parameter={"window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda window: window >= 5,
    ...
    CCI = IndicatorConfigurationAPI(
        ...
        IndicatorType=IndicatorType.Momentum,
        Input=lambda market: [market.High.Bid, market.Low.Bid, market.Close.Bid],
        Parameter={"window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda window: window >= 5,
    ...
    MACD = IndicatorConfigurationAPI(
        ...
        IndicatorType=IndicatorType.Momentum,
        Input=lambda market: [market.Close.Bid],
        Parameter={"fast_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]], "slow_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]], "signal_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
    ...
    PSAR = IndicatorConfigurationAPI(
        ...
        IndicatorType=IndicatorType.Momentum,
        Input=lambda market: [market.High.Bid, market.Low.Bid],
        Parameter={"acceleration": [[0.01, 0.2, 0.01], [-0.05, +0.05, 0.01], [-0.02, +0.02, 0.01]], "maximum": [[0.1, 0.5, 0.05], [-0.1, +0.1, 0.01], [-0.05, +0.05, 0.01]]},
        ...
        Output=["PSAR"],
        FilterBuy=lambda market, indicator, shift: market.Close.Bid.over(indicator.PSAR, shift),
        FilterSell=lambda market, indicator, shift: market.Close.Bid.under(indicator.PSAR, shift),
        SignalBuy=lambda market, indicator, shift: market.Close.Bid.crossover(indicator.PSAR, shift),
        SignalSell=lambda market, indicator, shift: market.Close.Bid.crossunder(indicator.PSAR, shift))

    # ==================== Volume ====================
    ADOSC = IndicatorConfigurationAPI(
        Name="Chaikin A/D Oscillator",
        IndicatorType=IndicatorType.Volume,
        Input=lambda market: [market.High.Bid, market.Low.Bid, market.Close.Bid, market.Volume],
        Parameter={"fast_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]], "slow_window": [[5, 50, 5], [-20, +20, 2], [-10, +10, 1]]},
        Constraints=lambda fast_window, slow_window: 5 <= fast_window < slow_window,
