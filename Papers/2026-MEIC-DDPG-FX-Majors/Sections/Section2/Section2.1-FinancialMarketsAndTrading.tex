...
The maximum drawdown is the worst value of $D(t)$ over the period and describes the largest loss an investor would have experienced from a peak. The mean drawdown averages $D(t)$ instead, and describes how far below its peak the account sits on a typical day rather than at its worst moment. Four ratios combine return and risk. All of them divide an annualised excess return by a measure of risk, differing only in which measure they use. The magnitude of that measure is taken, since a drawdown is negative under the definition above. Writing $R_f$ for the risk-free rate,
