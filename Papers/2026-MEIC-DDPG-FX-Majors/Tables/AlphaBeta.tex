...
\toprule
\textbf{Pair} & \textbf{Beta} & \textbf{Alpha (\%/yr)} & \textbf{Drift (\%/yr)} & \textbf{Mean (\%/yr)} & \textbf{Reading} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Decomposition of Equation~\ref{Equation:AlphaDrift}, from the yearly regression of Equation~\ref{Equation:AlphaBeta} over 2015 to 2025. Alpha is the return attributable to the policy and drift is the part explained by the pair's own movement. The two sum to the mean yearly return.}
