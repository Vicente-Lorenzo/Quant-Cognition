...
class GlobalAPI:
    ...
    GLOBAL_ZONE_STORAGE_ID: ComponentID | dict = ComponentID()
    GLOBAL_ZONE_ACTIVE_ID: ComponentID | dict = ComponentID()
    ...
    GLOBAL_SETTINGS_ZONE_ID: ComponentID | dict = ComponentID()
