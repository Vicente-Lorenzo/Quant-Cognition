...
class DoubleMovingAverageCrossAPI(TechnicalAPI):
    ...
    def __init__(self, name: str, fast_window: int, slow_window: int, type: MovingAverageType, mode: IndicatorMode) -> None:
        ...
        self.Fast: DoubleMovingAverageAPI = DoubleMovingAverageAPI(name=f"{name}.Fast", window=fast_window, type=type, mode=IndicatorMode.Off)
        self.Slow: DoubleMovingAverageAPI = DoubleMovingAverageAPI(name=f"{name}.Slow", window=slow_window, type=type, mode=IndicatorMode.Off)
